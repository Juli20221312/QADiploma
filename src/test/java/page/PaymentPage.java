...
public class PaymentPage {
    ...
    public PaymentPage fillingForm(CardHelper card) {
    ...
    public void checkApprovedForm() {
        approvedForm.shouldBe(Condition.visible, Duration.ofSeconds(15));
    }

    public void checkDeclinedForm() {
        declinedForm.shouldBe(Condition.visible, Duration.ofSeconds(15));
    }
